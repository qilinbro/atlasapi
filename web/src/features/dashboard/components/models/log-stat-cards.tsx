    ...
    <div className='overflow-hidden rounded-2xl border'>
      <div className='divide-border/60 grid min-w-0 grid-cols-2 divide-x sm:grid-cols-3 lg:grid-cols-5'>
        {items.map((it, idx) => {
          ...
          if (loading) {
            valueContent = (
              <div className='mt-1.5 flex flex-col gap-1.5 sm:mt-2'>
            ...
            valueContent = (
              <>
                <div className='text-muted-foreground mt-1.5 text-xl leading-tight font-semibold tracking-tight tabular-nums sm:mt-2 sm:text-3xl'>
                  --
                </div>
            ...
            valueContent = (
              <>
                <div
                  className='text-foreground mt-1.5 max-w-full truncate text-xl leading-tight font-semibold tracking-tight tabular-nums sm:mt-2 sm:text-3xl'
                  title={it.fullValue}
                >
                  {it.value}
                </div>
          ...
          return (
            ...
            >
              <div className='text-muted-foreground truncate text-sm leading-5 font-medium'>
                {it.title}
              </div>
