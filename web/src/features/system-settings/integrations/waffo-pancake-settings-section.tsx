  ...
  return (
    <div className='space-y-4 pt-4'>
      ...
      <div className='grid min-w-0 gap-x-5 gap-y-4 lg:grid-cols-2'>
        ...
        <div className='rounded-md bg-[var(--platinum)]/10 p-4 text-sm text-foreground lg:col-span-2 dark:bg-transparent dark:text-foreground'>
          <p className='mb-2 font-medium'>{t('Webhook Configuration:')}</p>
          <ul className='list-inside list-disc space-y-1'>
            <li>
              {t('Webhook URL (Test):')}{' '}
              <code className='rounded bg-[var(--platinum)]/25 px-1 py-0.5 text-xs dark:bg-blue-900'>
        ...
        */}
        <div className='space-y-4 pt-2 lg:col-span-2'>
          ...
          {/*
            ...
            */}
          <div className='rounded-md border border-[var(--platinum)]/35 bg-[var(--platinum)]/10 p-3 text-xs text-foreground dark:border-blue-900/60 dark:bg-transparent/40 dark:text-foreground'>
