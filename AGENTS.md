...
### 核心 Token（v2 白金主导，实施值以 theme.css 为准）

| Token | 亮色（主打） | 暗色 |
| --- | --- | --- |
| `--background` | `#F6F0E2` 淡香槟白金画布 | `#0B1613` 深墨绿黑 |
| `--card` | `#FBF7EC` + 纸纹 + 金属 hairline | `#12241E` |
| 品牌白金（哑光 `--platinum-matte`） | `#EFE7D2` 大面积铺陈 | 深底白金文字/线条 |
| 品牌白金（金属 `--platinum-metal`） | 香槟多停靠渐变，仅五处：标题字 / CTA 描边 / hover / 激活态 / 品牌标识 | 同左 |
| `--foreground` | `#2A2622` 暖深炭 | `#E8E3D5` 暖白 |
| **祖母绿（少量）** | 强调文本 + 唯一按钮色 `#1A4D3E` | 强调文本 + 按钮 `#2E6B57` |
| `--border` | `#E3D9C2` 香槟 hairline | 香槟半透明 hairline |
